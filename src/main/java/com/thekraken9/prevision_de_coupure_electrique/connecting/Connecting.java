package com.thekraken9.prevision_de_coupure_electrique.connecting;
    ...
    public static Connection getConnection(String base) throws Exception {
        try {
            if(base.equalsIgnoreCase("mysql")){
                ...
                return java.sql.DriverManager.getConnection("jdbc:postgresql://localhost:5432/prevision", "postgres", "postgres");
            }
        }catch (Exception e){
            throw e;
        }
